...
Unit03 / Chapter 7 補充：IPv4 address 是 32-bit IP address，以四個 [[IPv4 Addressing#Representation|Octet]] 的 [[IPv4 Addressing#Representation|Dotted Decimal Notation]] 表示，並透過 [[Prefix Length]] 或 [[Netmask]] 區分 network portion 與 host portion。

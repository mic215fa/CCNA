...
> [!info] Concept role
> [[IPv4 Addressing]] 的邊界子概念：以連續 1 與 0 表示 network/host boundary，等價於 prefix length。
...
- The subnet mask determines subnet size, usable address range, and the interesting octet used by [[Subnetting#Magic Number Method|Magic Number Method]].

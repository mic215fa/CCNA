...
> [!info] Concept role
> [[IPv4 Addressing]] 的 allocation 子概念：描述一般 subnet 中可指派給 interfaces 的 addresses 與 capacity。
...
- [[Subnetting#Five Subnet Attributes|Subnet Five Attributes]] reuses usable address range calculation for each generated subnet.
